...
class GeneratedLocalization {
  ...
  /// `от 6 до 12 символов`
  String get errNameValidarLenght {
    return Intl.message(
      'от 6 до 12 символов',
      name: 'errNameValidarLenght',
      desc: '',
      args: [],
    );
  }
  ...
  String get errEmailValidatorSymbolsRequired {
    return Intl.message(
      'символы @ и . обязательны',
      name: 'errEmailValidatorSymbolsRequired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `от 6 до 32 символов`
  String get errPasswordValidatorLenght {
    return Intl.message(
      'от 6 до 32 символов',
      name: 'errPasswordValidatorLenght',
      desc: '',
      args: [],
    );
  }
