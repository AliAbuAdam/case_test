...
abstract final class Config {
  ...
  static const String port =
      String.fromEnvironment('API_PORT', defaultValue: '8500');
  ...
  static const String databaseName =
      String.fromEnvironment('DATABASE_NAME', defaultValue: 'db');
  ...
  static const Duration resendTotpInterval = Duration(
      seconds: int.fromEnvironment('RESEND_TOTP_INTERVAL',
          defaultValue: /* 1 min */ 60));
